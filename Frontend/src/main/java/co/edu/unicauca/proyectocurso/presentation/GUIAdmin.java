...
public class GUIAdmin extends javax.swing.JFrame {
    ...
    GUIRegistrarUsuarios registrarUsuarios = new GUIRegistrarUsuarios(); // Crear instancia
    registrarUsuarios.setVisible(true); // Mostrar ventana
    registrarUsuarios.setLocationRelativeTo(null); // Centrar en la pantalla
